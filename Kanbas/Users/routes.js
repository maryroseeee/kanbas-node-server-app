...
export default function UserRoutes(app) {
    ...
    app.put("/api/users/:uid/courses/:cid", async (req, res) => {
        const { enrollmentId } = req.params;
        const enrollmentUpdates = req.body;
        const status = await enrollmentsDao.updateEnrollment(enrollmentId, enrollmentUpdates);
        res.send(status);
    ...
    app.get("/api/users/:userId/courses", findEnrollmentsForUser);
